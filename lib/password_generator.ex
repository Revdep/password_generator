defmodule PasswordGenerator do
  @moduledoc """
  Generator random password depending on paramenters, Module main function is generate(oprions)
  That funcion takes the options map
  options example
      options = {
        "length" => "5",
        "uppercase" => "false",
    ...
    The options are only for 4: "lenght", "numbers", "uppercase", "symbols".
  """

  @allowed_options [:length, :numbers, :uppercase, :symbols]

  @doc """
  Generate passwords for given options:
  ...
  defp validate_options_values_are_boolean(false, _length, _options) do
    {:error, "Only allowed for options values"}
  end
